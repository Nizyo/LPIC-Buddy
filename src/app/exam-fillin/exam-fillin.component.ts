...
@Component({
  selector: 'app-exam-fillin', // Angular-Selektor für die Verwendung der Komponente
  templateUrl: './exam-fillin.component.html', // Pfad zur HTML-Datei für die Darstellung
  styleUrls: ['./exam-fillin.component.css'] // Array mit Pfaden zu den CSS-Dateien für das Styling
})

// Die eigentliche Komponentenklasse implementiert OnInit-Interface
export class ExamFillinComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get<any[]>('assets/fragenfillin.json').subscribe((data: any[]) => {
