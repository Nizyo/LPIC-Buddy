...
@Component({
  selector: 'app-exam-all', // Angular-Selektor für die Verwendung der Komponente
  templateUrl: './exam-all.component.html', // Pfad zur HTML-Datei für die Darstellung
  styleUrls: ['./exam-all.component.css'] // Array mit Pfaden zu den CSS-Dateien für das Styling
  
})


// Die eigentliche Komponentenklasse implementiert OnInit-Interface
export class ExamAllComponent implements OnInit {
