...
@Component({
  selector: 'app-exam-sc', // Angular-Selektor für die Verwendung der Komponente
  templateUrl: './exam-sc.component.html', // Pfad zur HTML-Datei für die Darstellung
  styleUrls: ['./exam-sc.component.css'] // Array mit Pfaden zu den CSS-Dateien für das Styling
})

// Die eigentliche Komponentenklasse implementiert OnInit-Interface
export class ExamScComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private router: Router, private cdr: ChangeDetectorRef) {}  ngOnInit() {
  ...
  isSelected(index: number): boolean {
    return this.selectedAnswers[this.currentQuestionIndex]?.includes(index);
}
